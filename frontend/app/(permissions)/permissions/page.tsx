...
import { Construction, Key, Lock } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)]">
      <div className="text-center max-w-2xl px-6">
        <div className="relative mb-8">
          ...
          <Key className="h-12 w-12 text-primary absolute bottom-0 right-1/3 animate-pulse" />
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-8">
          ...
          <ul className="space-y-2 text-left text-muted-foreground">
            <li className="flex items-center gap-2">
              ...
              Crear y gestionar permisos del sistema
            </li>
            <li className="flex items-center gap-2">
              <span className="h-1.5 w-1.5 rounded-full bg-primary"></span>
              Definir niveles de acceso granulares
            </li>
            <li className="flex items-center gap-2">
              <span className="h-1.5 w-1.5 rounded-full bg-primary"></span>
              Asociar permisos a roles específicos
            </li>
            <li className="flex items-center gap-2">
              <span className="h-1.5 w-1.5 rounded-full bg-primary"></span>
              Auditar y monitorear uso de permisos
            </li>
          </ul>
        </div>
